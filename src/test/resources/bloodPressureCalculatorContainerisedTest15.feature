...
Feature: Invalid (double) values
  ...
  Scenario: Test Case 15
    ...
    Then "Please enter a valid value. The two nearest values are 172 and 173." error message is displayed under the "Systolic" field on the 'Blood Pressure Containerised' calculator page
    When user enters "172" in the Systolic field on the 'Blood Pressure' calculator page
    Then user clicks on the submit button on the 'Blood Pressure' calculator page
    Then "Please enter a valid value. The two nearest values are 66 and 67." error message is displayed under the "Diastolic" field on the 'Blood Pressure Containerised' calculator page
