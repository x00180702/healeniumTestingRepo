...
Feature: Check using scenario outline
  ...
  Scenario Outline: Test Case 17
    ...
    Examples:
      ...
      | bloodpressureTestScenario4 | 170      | 95        | 30       | High Blood Pressure   | Average value for your age group [30-34] is 123/82 | Mean Arterial Pressure : 246 | Pulse Pressure : 81 |