...
Feature: Boundary Value Analysis Testing
  ...
  Scenario Outline: Test Case 19
    ...
    Examples:
      ...
      | bloodpressureTestScenarioBVA1 | 70       | 40        | 15       | Low Blood Pressure      | Average value for your age group [15-19] is 120/78 | Mean Arterial Pressure : 96  | Pulse Pressure : 31 |
