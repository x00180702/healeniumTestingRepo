...
Feature: Boundary Value Analysis Testing
  ...
  Scenario Outline: Test Case 19
    ...
    Examples:
      ...
      | bloodpressureTestScenario2 | 90       | 60        | 20       | Normal Blood Pressure | Average value for your age group [20-24] is 120/79 | Mean Arterial Pressure : 130 | Pulse Pressure : 31 |
      | bloodpressureTestScenario3 | 140      | 80        | 25       | High Blood Pressure   | Average value for your age group [25-29] is 121/80 | Mean Arterial Pressure : 193 | Pulse Pressure : 61 |
