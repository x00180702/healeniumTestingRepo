...
Feature: Check using scenario outline - Negative Test
  ...
  Scenario Outline: Test Case 18
    ...
    Examples:
      ...
      | bloodpressureTestScenarioNeg4 | 180      | 100       | 30       | Pre-High Blood Pressure | Average value for your age group [20-24] is 123/82 | Mean Arterial Pressure: 245 | Pulse Pressure: 41 |